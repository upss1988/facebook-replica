<template>
    <div class="bg-white h-12 p-4 flex items-center">
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full pl-8 text-sm w-48 bg-gray-200 h-8 focus:shadow-outline" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link to="/" class="h-full px-6">
